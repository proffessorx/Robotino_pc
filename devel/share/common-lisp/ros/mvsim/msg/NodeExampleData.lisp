...
(cl:defmethod cl:initialize-instance :after ((m <NodeExampleData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NodeExampleData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mvsim-msg:<NodeExampleData> is deprecated: use mvsim-msg:NodeExampleData instead.")))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <NodeExampleData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mvsim-msg:message-val is deprecated.  Use mvsim-msg:message instead.")
  (message m))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <NodeExampleData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mvsim-msg:a-val is deprecated.  Use mvsim-msg:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <NodeExampleData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mvsim-msg:b-val is deprecated.  Use mvsim-msg:b instead.")
  (b m))
